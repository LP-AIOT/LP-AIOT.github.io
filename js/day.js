...
if(m==8&&dd==15){//搞来玩的，鬼子投降
    console.log("小日子投降"+(y-1945).toString()+"年了！");
    if(sessionStorage.getItem("isPopupWindow")!="1"){
        Swal.fire("小日子投降"+(y-1945).toString()+"年了！");
        sessionStorage.setItem("isPopupWindow","1");
    }
}
if(m==1&&dd==1){//元旦节
...
//相识
if(m==3&&dd<=18){
    console.log("和你相识的第"+(y-2019).toString()+"年，依然(๑′ᴗ‵๑)Ｉ Lᵒᵛᵉᵧₒᵤ❤！");
    if(sessionStorage.getItem("isPopupWindow")!="1"){
        Swal.fire("和你相识的第"+(y-2019).toString()+"年，依然(๑′ᴗ‵๑)Ｉ Lᵒᵛᵉᵧₒᵤ❤");
        sessionStorage.setItem("isPopupWindow","1");
    }
}
...
//相知
if(m==6&&dd<=25){
    console.log("和你相知的第"+(y-2022).toString()+"年，依然(๑′ᴗ‵๑)Ｉ Lᵒᵛᵉᵧₒᵤ❤");
    if(sessionStorage.getItem("isPopupWindow")!="1"){
        Swal.fire("和你相知的第"+(y-2022).toString()+"年，依然(๑′ᴗ‵๑)Ｉ Lᵒᵛᵉᵧₒᵤ❤");
        sessionStorage.setItem("isPopupWindow","1");
    }
}
...
// 你的生日
if((lunar["IMonthCn"]=="十二月"&&lunar["IDayCn"]=="十四")){
    //你的生日
    console.log("祝你生日快乐！");
    if(sessionStorage.getItem("isPopupWindow")!="1"){
        Swal.fire("祝你生日快乐！");
...
// 我的生日
if((lunar["IMonthCn"]=="十月"&&lunar["IDayCn"]=="三十")){
    //我的生日
    console.log("生日快乐！");
    if(sessionStorage.getItem("isPopupWindow")!="1"){
        Swal.fire("生日快乐！");
...
//第一天测试
if(m==9&&dd<=23){
    console.log("今天是自动弹窗功能的第"+(y-2021).toString()+"年，依然(๑′ᴗ‵๑)Ｉ Lᵒᵛᵉᵧₒᵤ❤！");
    if(sessionStorage.getItem("isPopupWindow")!="1"){
        Swal.fire("今天是自动弹窗功能的第"+(y-2021).toString()+"年，依然(๑′ᴗ‵๑)Ｉ Lᵒᵛᵉᵧₒᵤ❤");
        sessionStorage.setItem("isPopupWindow","1");
    }
}
...
//第二天测试
if(m==3&&dd<=18){
    console.log("今天是自动弹窗功能的第"+(y-2020).toString()+"年，依然(๑′ᴗ‵๑)Ｉ Lᵒᵛᵉᵧₒᵤ❤！");
    if(sessionStorage.getItem("isPopupWindow")!="1"){
        Swal.fire("今天是自动弹窗功能的第"+(y-2020).toString()+"年，依然(๑′ᴗ‵๑)Ｉ Lᵒᵛᵉᵧₒᵤ❤");
        sessionStorage.setItem("isPopupWindow","1");
    }
}
...
//第三天测试
if(m==3&&dd<=18){
    console.log("今天是自动弹窗功能的第"+(y-2019).toString()+"年，依然(๑′ᴗ‵๑)Ｉ Lᵒᵛᵉᵧₒᵤ❤！");
    if(sessionStorage.getItem("isPopupWindow")!="1"){
        Swal.fire("今天是自动弹窗功能的第"+(y-2019).toString()+"年，依然(๑′ᴗ‵๑)Ｉ Lᵒᵛᵉᵧₒᵤ❤");
        sessionStorage.setItem("isPopupWindow","1");
    }
}